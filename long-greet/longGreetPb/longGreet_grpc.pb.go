...
func (c *greetServiceClient) LongGreet(ctx context.Context, opts ...grpc.CallOption) (GreetService_LongGreetClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[0], "/longGreet.GreetService/LongGreet", opts...)
	if err != nil {
		return nil, err
	}
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "longGreet.GreetService",
	...
	Metadata: "long-greet/longGreetPb/longGreet.proto",
}
